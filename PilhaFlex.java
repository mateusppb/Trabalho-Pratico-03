...
class Show {
    ...
    public void setTitle(String title) {
        title = title.replace("\"", "");
        this.title = title.isEmpty() ? "NaN" : title;
    }
...
class Pilha {
    ...
    public Show remover()throws Exception {
        if(topo == null) throw new Exception("Impossível, pilha vazia!");
    ...
    public void exibir() {
        calcular_Tamanho();
        exibir(topo,tamanho - 1);
    }
    private void exibir (Celula i,int pos) {
        if (i != null) {
